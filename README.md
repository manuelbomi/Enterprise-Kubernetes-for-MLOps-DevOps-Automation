...
> [NOTE!]
> So im essence, it is the YAML file that defines what pods, services, and deployments should exist, <ins>but</ins> Kubernetes itself is the system that brings them to life.
